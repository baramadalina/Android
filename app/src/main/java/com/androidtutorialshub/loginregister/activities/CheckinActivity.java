...
import com.androidtutorialshub.loginregister.helpers.ResourcesHelper;
import com.androidtutorialshub.loginregister.model.Action;
...
public class CheckinActivity extends Activity {
    ...
    public void checkin(View btnCheckin) {
        ...
        Map<String, Action> checkinMap = vagueAdapter.getData().get(DateUtil.formatDate(year, month, dayOfMonth, MONTH_FORMAT));
        checkinMap.put(DateUtil.formatDate(year, month, dayOfMonth, DAY_OF_MONTH_FORMAT), new Action());
