...
public class FilterDialog extends Dialog
    ...
    private AddReservationEventActivity mActivity;
    ...
    public FilterDialog(AddReservationEventActivity context) {
        super(context);
        mActivity = context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reservation_filter_free_intervals);
